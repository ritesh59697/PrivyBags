...
import { Search, Loader2, AlertCircle, AtSign, Wallet } from "lucide-react";
    ...
    <div className="relative w-full">
      ...
      <div className="relative">
        ...
        <input
          ...
          onKeyDown={(e) => {
            // If Enter pressed and exactly one result, navigate immediately
          ...
          className="w-full bg-gray-900 border border-gray-800 rounded-xl
                     ...
                     focus:border-purple-700 transition-all"
          autoComplete="off"
          spellCheck={false}
        />
      ...
      {/* ── Dropdown ───────────────────────────────────────────────────────── */}
      {showDropdown && (
        <div className="absolute top-full mt-2 w-full bg-gray-900 border border-gray-800
          ...
          {state === "found" && results.map((creator) => (
            <button
              key={creator.slug}
              className="w-full text-left hover:bg-gray-800/60 transition-colors"
